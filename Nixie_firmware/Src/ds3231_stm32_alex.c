...
//untested
void DS3231_set_alarm_short(I2C_HandleTypeDef *hi2c, uint8_t twelve_hour, uint8_t hour, uint8_t min, uint8_t sec, ALARM_NUMBER alarm_number){
	uint8_t write_buffer[3];
	write_buffer[0]= dec2bcd(sec);
	write_buffer[1] = dec2bcd(min);
