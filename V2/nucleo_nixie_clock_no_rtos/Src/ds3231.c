...
void DS3231_write_date_short(I2C_HandleTypeDef *hi2c, uint16_t year,
...
void DS3231_read_date_short(I2C_HandleTypeDef *hi2c, uint16_t* year,
		uint8_t* month, uint8_t* date, uint8_t* day)
{
...
void DS3231_write_time(I2C_HandleTypeDef *hi2c, ds3231_time_t* time)
{
...
void DS3231_read_time(I2C_HandleTypeDef *hi2c, ds3231_time_t* return_struct)
{
...
//untested
float DS3231_read_temp(I2C_HandleTypeDef *hi2c)
{
	float return_temp;
